...
const categoryAnalysis = `${Base}/ring/board/categoryAnalysis`;// 环形图
const overviewOfOnlineAndOfflineOrders = `${Base}/ring/board/overviewOfOnlineAndOfflineOrders`;// 线上线下订单概览
const rankingList = `${Base}/ring/board/rankingList`;// 门店回收费用排行榜
const WeatherDataInfo = `https://restapi.amap.com/v3/weather/weatherInfo?city=410100&key=8d4730fb158ee7adef7c120d2cda7e8a`; // 高德地图天气接口
...
export default {
    ...
    trendStatistics,
    categoryAnalysis,
    overviewOfOnlineAndOfflineOrders,
    rankingList,
}
